...
const Pagination = ({page, pagesLength, setPage}) => {
    ...
    // const limitPages = initialPages + pagesPerBlock - 1
    ...
    const handlePrevListPages = () => {
        setPage(initialPage - pagesPerBlock)
    }

    const handleNextListPages = () => {
        setPage(initialPage + pagesPerBlock)
    }
  ...
  return (
   <div className='pagination'>
     ...
     {
        page > 8 &&
        <div onClick={handlePrevListPages} className='prev_list-pages'>...</div>
     }
    ...
    {
        page < pagesLength &&
        <div onClick={handleNextListPages} className='next_list-pages'>...</div>
    }
    {
        page < pagesLength &&
